...
export const selectCityButtons = [
  ...
  { text: '苗栗縣', name: 'MiaoliCounty', className: '' },
  { text: '台中市', name: 'Taichung', className: '' },
  { text: '南投縣', name: 'NantouCounty', className: '' },
  { text: '彰化縣', name: 'ChanghuaCounty', className: '' },
  { text: '雲林縣', name: 'YunlinCounty', className: '' },
  { text: '嘉義市', name: 'Chiayi', className: '' },
  { text: '嘉義縣', name: 'ChiayiCounty', className: '' },
  { text: '台南市', name: 'Tainan', className: '' },
  { text: '高雄市', name: 'Kaohsiung', className: '' },
  { text: '屏東縣', name: 'PingtungCounty', className: '' },
  { text: '台東縣', name: 'TaitungCounty', className: '' },
  { text: '花蓮縣', name: 'HualienCounty', className: '' },
  { text: '宜蘭縣', name: 'YilanCounty', className: '' },
  { text: '澎湖縣', name: 'PenghuCounty', className: '' },
  { text: '金門縣', name: 'KinmenCounty', className: '' },
  { text: '連江縣', name: 'LienchiangCounty', className: '' },
